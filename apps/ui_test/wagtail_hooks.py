...
print("ui_test wagtail_hooks.py loaded")
    ...
    features.register_converter_rule(
        ...
        feature_name,
        {
            ...
            "from_database_format": {
                "span[data-annotation]": AnnotationEntityElementHandler(type_)
            },
            "to_database_format": {
                "entity_decorators": {type_: annotation_entity_decorator}
            },
        },
    )
...
def register_remove_annotation_feature(features):
    ...
    features.register_converter_rule(
        ...
        feature_name,
        {
            # Note here that the conversion is more complicated than for blocks and inline styles.
            "from_database_format": {
                "span[data-remove-annotation]": RemoveAnnotationElementHandler(type_)
            },
            "to_database_format": {
                "entity_decorators": {type_: remove_annotations_decorator}
            },
        },
    )
...
#             WhitelistRule(
#                 "h1", attribute_rule({"class": True, "id": True, "data": True})
#             ),
#             WhitelistRule(
#                 "h2", attribute_rule({"class": True, "id": True, "data": True})
#             ),
#             WhitelistRule(
#                 "h3", attribute_rule({"class": True, "id": True, "data": True})
#             ),
#             WhitelistRule(
#                 "h4", attribute_rule({"class": True, "id": True, "data": True})
#             ),
#             WhitelistRule(
#                 "h5", attribute_rule({"class": True, "id": True, "data": True})
#             ),
#             WhitelistRule("a", attribute_rule({"class": True, "href": True})),
#             WhitelistRule(
#                 "div",
#                 attribute_rule(
#                     {"class": True, "id": True, "data": True, "style": True}
#                 ),
#             ),
#             WhitelistRule(
#                 "canvas",
